...
<div class="selection:bg-brand-lime selection:text-black font-sans min-h-screen relative" style="background-color: #008080;">
    <style>
        .login-bg-overlay {
            position: fixed;
            inset: 0;
    ...
    <div class="relative z-10 min-h-screen flex flex-col lg:flex-row">
        ...
        <div class="hidden lg:flex flex-[1.3] flex-col justify-center px-20 xl:px-32 text-white">
            <div class="max-w-2xl animate-up">
                <div class="inline-flex items-center px-4 py-1.5 rounded-full bg-white/10 border border-white/20 text-xs font-bold mb-8 uppercase tracking-widest">
                    <span class="w-1.5 h-1.5 rounded-full bg-lime-400 mr-2 animate-pulse"></span>
                    UIN SAIZU Purwokerto
                </div>

                <h1 class="text-6xl font-black leading-[1.1] tracking-tight mb-8">
                    Sistem Informasi <br />
                    <span class="text-lime-accent">Perjalanan Dinas</span>
                </h1>

                <div class="h-2 w-24 bg-lime-accent mb-10 rounded-full"></div>
                ...
                <div class="flex items-center gap-6 mb-20">
                    <a href="#" class="h-14 px-10 rounded-2xl bg-lime-accent text-black font-black flex items-center shadow-lg hover:brightness-110 transition-all hover:-translate-y-1">
                        Pelajari Lebih Lanjut
                        <svg class="ml-2 w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M14 5l7 7m0 0l-7 7m7-7H3" />
                        </svg>
                    </a>
                    <a href="#" class="h-14 px-10 rounded-2xl border-2 border-white/40 text-white font-black flex items-center hover:bg-white/10 transition-all">
                        Panduan Pengguna
                    </a>
                </div>

                <!-- Stats -->
                <div class="grid grid-cols-3 gap-12 pt-10 border-t border-white/20">
                    <div>
                        <p class="text-4xl font-black text-lime-accent mb-1">500+</p>
                        <p class="text-xs text-white/70 uppercase font-bold tracking-widest leading-tight">Perjalanan<br />Dinas</p>
                    </div>
                    <div>
                        <p class="text-4xl font-black text-lime-accent mb-1">50+</p>
                        <p class="text-xs text-white/70 uppercase font-bold tracking-widest leading-tight">Dosen &<br />Staff</p>
                    </div>
                    <div>
                        <p class="text-4xl font-black text-lime-accent mb-1">99%</p>
                        <p class="text-xs text-white/70 uppercase font-bold tracking-widest leading-tight">Tingkat<br />Kepuasan</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="w-full max-w-md animate-up" style="animation-delay: 0.2s">
                <div class="login-card">
                    ...
                    <div class="text-center mb-10">
                        ...
                        <p class="text-gray-500 font-bold text-sm">Sistem Informasi Perjalanan Dinas</p>
                    </div>
                    ...
                    <form wire:submit="login" class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                ...
                                <input wire:model="nip" type="text" required placeholder="Masukkan NIP"
                                    class="w-full h-14 pl-14 pr-4 bg-gray-50 border-2 border-gray-100 rounded-2xl focus:bg-white focus:border-[#0097a7] focus:ring-4 focus:ring-[#0097a7]/10 transition-all font-medium">
                            </div>
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                ...
                                <input wire:model="password" type="{{ $showPassword ? 'text' : 'password' }}" required placeholder="Masukkan password"
                                    class="w-full h-14 pl-14 pr-14 bg-gray-50 border-2 border-gray-100 rounded-2xl focus:bg-white focus:border-[#0097a7] focus:ring-4 focus:ring-[#0097a7]/10 transition-all font-medium">
                        ...
                        <div class="flex items-center justify-between px-1">
                            <label class="flex items-center cursor-pointer">
                                <input type="checkbox" wire:model="remember" class="w-5 h-5 rounded border-gray-300 text-[#0097a7] focus:ring-[#0097a7]/20">
                                <span class="ml-2.5 text-sm font-bold text-gray-500">Ingat saya</span>
                            </label>
                            <a href="#" class="text-sm font-black text-[#0097a7] hover:underline">Lupa password?</a>
                        </div>

                        <button type="submit" wire:loading.attr="disabled"
                            class="w-full h-14 btn-teal-primary shadow-lg flex items-center justify-center gap-2">
                    ...
                    <div class="mt-12 flex flex-col items-center gap-4 border-t border-gray-100 pt-8">
                        ...
                        <div class="flex items-center gap-4 text-gray-600 font-black text-sm uppercase">
                            <span>UIN SAIZU</span>
                            <span class="text-lime-500 text-lg">•</span>
                            <span>PUSKOM</span>
                        </div>
                ...
                <div class="text-center mt-8">
                    <p class="text-white/80 text-sm font-bold">
                        Bantuan? <a href="#" class="text-lime-accent hover:underline decoration-2 underline-offset-4">Hubungi Admin IT</a>
                    </p>
                </div>
            </div>
        </div>
