...
<div class="selection:bg-brand-lime selection:text-black">
    <style>
        .login-vignette {
    ...
    <div
        class="min-h-screen flex flex-col lg:flex-row bg-brand-teal relative overflow-hidden font-sans">
        ...
        <div class="flex-1 flex items-center justify-center p-6 lg:p-12 z-20">
            <div class="w-full max-w-md animate-fade-in">
                <div
                    class="bg-white/95 backdrop-blur-2xl rounded-[2.5rem] shadow-xl p-10 lg:p-14 relative overflow-hidden border border-white/20">
                    ...
                    <form wire:submit="login" class="space-y-6 relative">
                        <!-- NIP -->
                        <div class="space-y-2">
                            <label for="form.email" class="text-sm font-bold text-gray-700 ml-1">Username / NIP</label>
                            <div class="relative group">
                                <input wire:model="form.email" id="form.email" type="text" name="nip" required autofocus
                                      class="w-full h-14 pl-14 pr-5 bg-gray-50 border-2 border-gray-100 rounded-2xl focus:border-brand-teal focus:ring-4 focus:ring-brand-teal/10 transition-all placeholder:text-gray-400 font-medium {{ $errors->has('form.email') ? 'border-red-500 ring-2 ring-red-200' : '' }}"
                                      placeholder="Masukkan NIP (angka saja)" aria-invalid="{{ $errors->has('form.email') ? 'true' : 'false' }}" autocomplete="username"
                                />
                            ...
                            <p class="text-xs text-gray-400 ml-1">NIP hanya angka, tanpa spasi atau tanda baca.</p>
                            @error('form.email')
                        ...
                        <!-- Password -->
                        <div class="space-y-2">
                            <label for="form.password" class="text-sm font-bold text-gray-700 ml-1">Password</label>
                            <div class="relative group">
                                <input
                                      ...
                                      name="password"
                                      required
                                      class="w-full h-14 pl-14 pr-14 bg-gray-50 border-2 border-gray-100 rounded-2xl focus:border-brand-teal focus:ring-4 focus:ring-brand-teal/10 transition-all placeholder:text-gray-400 font-medium {{ $errors->has('form.password') ? 'border-red-500 ring-2 ring-red-200' : '' }}"
